          ...
          <div id="datatable-buttons_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
            <div class="dt-buttons btn-group">
                  ...
                  <table id="datatable-buttons" style="width: 100%;" class="table table-striped table-bordered dataTable no-footer dtr-inline collapsed" role="grid" aria-describedby="datatable-buttons_info">
                      ...
                      <td tabindex="0" class="sorting_1">      <input type="submit" onclick="createsupplierpayment('<?php echo $value->id; ?>');" style="float: right; width:150px;" class="btn btn-block btn-success" value="Create supplier payment"></td>
