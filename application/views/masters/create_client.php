...
<div class=" row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" required id="client_name" placeholder="Enter supplier name">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="code">Name Arabic</label>
                      <input type="text" class="form-control" required id="client_name_arabic" placeholder="Enter supplier name">
                    </div></div>
                    <div class=" row">
                    <div class="form-group col-md-6">
